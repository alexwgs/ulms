...
2. 后端 Controller 业务下沉 Service（college：CourseController、edu：QuesBankController/BrushScoreService、sys：QuickUrl/Dictionary/Ad/ErrorLog/UserFiles/OperLog、edu：ExamInfo/DailyConfig、oht：StatusType/OhtRole/RoleList/QuickMemo 已完成；flow/youngTalk 等其余 Controller 待推广）
