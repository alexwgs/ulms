...
2. 后端 Controller 业务下沉 Service（college：CourseController/TeachGroup、edu：QuesBankController/BrushScoreService/ExamInfo/DailyConfig/BrushConfig、sys：QuickUrl/Dictionary/Ad/ErrorLog/UserFiles/OperLog、oht：StatusType/OhtRole/RoleList/QuickMemo、helper：HelperArtical 已完成；flow/youngTalk 等其余 Controller 待推广）
